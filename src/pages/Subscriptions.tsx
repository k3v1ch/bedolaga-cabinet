...
function EmptyState({ onBuy }: { onBuy: () => void }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onBuy}
        className="rounded-xl bg-accent-500 px-8 py-3 text-[15px] font-medium text-on-accent transition-colors hover:bg-accent-600"
      >
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {!isLoading && hasActivePaid && (
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-xl px-4 py-2 text-[15px] font-medium transition-colors"
            style={{
