  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-accent-500 px-6 py-3 text-[15px] font-medium text-on-accent transition-colors hover:bg-accent-400"
      >
    ...
    >
      ...
      <div className="flex w-full flex-col gap-3">
        <button
          type="button"
          onClick={onRetry}
          className="w-full rounded-xl bg-accent-500 px-6 py-3 text-[15px] font-medium text-on-accent transition-colors hover:bg-accent-400"
        >
          {t('common.retry')}
        </button>
        <button
